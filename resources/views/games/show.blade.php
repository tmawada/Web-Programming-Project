            ...
            <div class="bg-cyber-alt overflow-hidden shadow-[0_0_30px_rgba(217,70,239,0.15)] sm:rounded-lg border border-cyber-secondary/30">
                ...
                <div class="p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-cyber-bg p-6 rounded-xl border border-cyber-secondary/30 h-fit">
                        ...
                        @if($isPurchased)
                            <!-- Purchased Badge -->
                            <div class="mb-4 bg-green-500/20 border-2 border-green-500 rounded-lg p-4 text-center">
                                <div class="flex items-center justify-center gap-2 mb-2">
                                    <svg class="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-green-400 font-bold text-lg">Purchased</span>
                                </div>
                                <p class="text-green-300 text-sm">You own this game</p>
                            </div>
                            
                            <a href="{{ route('library.index') }}" class="block w-full text-center bg-cyber-secondary hover:bg-cyber-primary text-white font-bold py-4 px-6 rounded-lg shadow-lg transform transition hover:scale-105 mb-4">
                                View in Library
                            </a>
                        @else
                            @if($inCart)
